...
export class LandingComponent implements OnInit {
  ...
  defaultDescription =
    "Independent artists put their music on the world leading streaming platforms with ease — because that’s how it should be. We'll handle your distribution so you can flawlessly make even more nicer Tunes.";
  artists: any = [];
  logos: any[] = [];
  logosOptions = {
    freeScroll: true,
  ...
  getAllArtists() {
    fetch(environment.base_url + "artist/top?status=verified&mode=minimal")
      .then((res) => res.json())
      .then((data) => {
        let results: any = {};
        results = data;
